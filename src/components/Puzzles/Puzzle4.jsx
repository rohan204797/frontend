...
const Puzzle4 = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0)
    document.title = "Mate in One Move (Easy) | Chess Master - Tactical Chess Puzzles"
    ...
    metaDescription.content =
      "Challenge yourself with this easy 'Mate in One Move' chess puzzle. Find the winning move that leads to an immediate checkmate."
    ...
    canonicalLink.href = window.location.origin + "/puzzles/mate-in-one-easy"

    const structuredData = {
      "@context": "https://schema.org",
      "@type": "Game",
      name: "Mate in One Move (Easy) - Chess Puzzle",
      description:
        "Challenge yourself with this easy 'Mate in One Move' chess puzzle. Find the winning move that leads to an immediate checkmate.",
      genre: "Chess Puzzle",
    ...
    >
      ...
      <header className="relative z-10 w-screen bg-gradient-to-r from-indigo-900 via-blue-800 to-indigo-900 border-b-4 border-yellow-500 shadow-lg py-4 mt-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <h1 className="text-xl md:text-3xl font-bold text-yellow-400 drop-shadow-md">MATE IN ONE MOVE (EASY)</h1>
        ...
        <div className="max-w-6xl mx-auto">
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-yellow-400 mb-2">Mate in One Move (Easy)</h2>
                      <p className="text-white mb-2">
                        This is a simple checkmate puzzle where White can win in just one move. Look for the knight's
                        powerful position and find the winning move.
                      </p>
                      <p className="text-white">
                        Hint: Knights are excellent at delivering checkmate when the enemy king has limited mobility.
                        Look for a knight move that attacks the king while preventing any escape.
                      </p>
                    </div>
                  </div>
                  <button
                        ...
                        >
                          <div className="bg-blue-900/30 rounded-lg p-4 border border-blue-600">
                            <div className="text-center">
                              <p className="text-2xl font-bold text-yellow-400 mb-2">Knight to e2</p>
                              <p className="text-blue-200">
                                The knight move to e2 delivers checkmate. The black king has no legal moves and cannot
                                escape the check.
                              </p>
                            </div>
                          </div>
          ...
          >
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              This puzzle is a great way to practice recognizing checkmate patterns. Can you find the winning move for
              White? Remember, knights are powerful pieces that can jump over other pieces and attack from unexpected
              angles.
            </p>
