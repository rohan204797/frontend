...
const Puzzle5 = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0)
    document.title = "Mate in One Move (Normal) | Chess Master - Tactical Chess Puzzles"
    ...
    metaDescription.content =
      "Challenge yourself with this intermediate 'Mate in One Move' chess puzzle. Find the winning rook move that leads to an immediate checkmate."
    ...
    canonicalLink.href = window.location.origin + "/puzzles/mate-in-one-normal"

    const structuredData = {
      "@context": "https://schema.org",
      "@type": "Game",
      name: "Mate in One Move (Normal) - Chess Puzzle",
      description:
        "Challenge yourself with this intermediate 'Mate in One Move' chess puzzle. Find the winning rook move that leads to an immediate checkmate.",
      genre: "Chess Puzzle",
    ...
    >
      ...
      <header className="relative z-10 w-screen bg-gradient-to-r from-indigo-900 via-blue-800 to-indigo-900 border-b-4 border-yellow-500 shadow-lg py-4 mt-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <h1 className="text-xl md:text-3xl font-bold text-yellow-400 drop-shadow-md">MATE IN ONE MOVE (NORMAL)</h1>
        ...
        <div className="max-w-6xl mx-auto">
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-yellow-400 mb-2">Mate in One Move (Normal)</h2>
                      <p className="text-white mb-2">
                        This is an intermediate checkmate puzzle where White can win in just one move. Look for the
                        rook's powerful position and find the winning move.
                      </p>
                      <p className="text-white">
                        Hint: Rooks are excellent at delivering checkmate when they can control an entire rank or file.
                        Look for a rook move that attacks the king while preventing any escape.
                      </p>
                    </div>
                  </div>
                  <button
                        ...
                        >
                          <div className="bg-blue-900/30 rounded-lg p-4 border border-blue-600">
                            <div className="text-center">
                              <p className="text-2xl font-bold text-yellow-400 mb-2">Rook anywhere between g1 to g5</p>
                              <p className="text-blue-200">
                                Moving the rook along the g-file (to any square from g1 to g5) delivers checkmate. The
                                black king has no legal moves and cannot escape the check.
                              </p>
                            </div>
                          </div>
                        </motion.div>
          ...
          >
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              This puzzle is a great way to practice recognizing checkmate patterns with rooks. Can you find the winning
              move for White? Remember, rooks are powerful pieces that control entire ranks and files.
            </p>
