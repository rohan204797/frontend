...
const Puzzle2 = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0)
    document.title = "The Mighty Knight | Chess Master - Challenging Chess Puzzles"
    ...
    metaDescription.content =
      "Challenge yourself with 'The Mighty Knight' - a brilliant chess puzzle composed by Ottó Bláthy in 1922. White has just one pawn and a king, yet can still win against all of Black's pieces."
    ...
    canonicalLink.href = window.location.origin + "/puzzles/mighty-knight"

    const structuredData = {
      "@context": "https://schema.org",
      "@type": "Game",
      name: "The Mighty Knight - Chess Challenge",
      description:
        "Challenge yourself with 'The Mighty Knight' - a brilliant chess puzzle composed by Ottó Bláthy in 1922. White has just one pawn and a king, yet can still win against all of Black's pieces.",
      genre: "Chess Puzzle",
    ...
    >
      ...
      <header className="relative z-10 w-screen bg-gradient-to-r from-indigo-900 via-blue-800 to-indigo-900 border-b-4 border-yellow-500 shadow-lg py-4 mt-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <h1 className="text-xl md:text-3xl font-bold text-yellow-400 drop-shadow-md">THE MIGHTY KNIGHT</h1>
        ...
        <div className="max-w-6xl mx-auto">
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-yellow-400 mb-2">The Mighty Knight</h2>
                      <p className="text-white mb-2">
                        This puzzle was composed by Ottó Bláthy in 1922. This involves a lot of chess thinking in terms
                        of strategy, tactics, moves & ideas.
                      </p>
                      <p className="text-white">
                        White has just one pawn and a king whereas, black has all his pieces. But still White can win
                        this game. White needs to find the best moves & ideas in which white can trap black in the
                        corner and checkmate the black king.
                      </p>
                        ...
                        >
                          <div className="aspect-video w-full overflow-hidden rounded-lg border-2 border-blue-600 shadow-lg">
                            <iframe
                              ...
                              title="The Mighty Knight Solution"
                              frameBorder="0"
          ...
          >
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              This puzzle will test your strategic thinking and tactical skills. White appears to be at a severe
              disadvantage, but there's a brilliant sequence that leads to victory. Can you find it?
            </p>
